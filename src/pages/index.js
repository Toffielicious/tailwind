          ...
          <div class="flex lg:flex-row justify-around sm:flex-col sm:gap-2 lg:gap-0 updatesSec">
            <div className='wid30 md:flex-col lg:flex-col' >
              <div className="announcements" >
                <div className=''>
                  <a className="py-4 mb-2 font-bold pl-8 announcements2 m-0 text-red hover:cursor-pointer">Announcements and Advisories</a>
            ...
            <div className='flex flex-col mw'>
              <div class="flex flex-row justify-between ">
                ...
                <div className='flex-row gap-1'>
                  ...
                  <div class="flex gap-1">
                    <button className='border bc rounded-sm items-center hover:bg-red hover:text-white' onclick={Prev}>
                      <i class="fa fa-sharp fa-solid fa-chevron-left px-1  text-grayest" style={{ fontSize: '12px' }}></i>
                    </button>
                    <button className='border bc rounded-sm items-center hover:bg-red' onclick={Next}>
              ...
              <div className='flex flex-row pb-4'>
                <div class=" flex flex-row">
                  ...
                  <p className='text-l'>________________________</p>
                </div>
              </div>
