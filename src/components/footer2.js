        ...
        <>
            <div class="flex flex-col md:flex-row justify-center md:gap-40">
                <div class="flex flex-row">
                    ...
                    <div>
                        <p class="text-sssm font-bold text-blackish p-ft uppercase pb-2 pt-8">Republic of the Philippines</p>
                ...
                <div class="mt-8 md:mt-0 md:ml-8">
                    <p class="text-sssm font-bold text-blackish p-ft uppercase pb-2">About GOVPH</p>
                ...
                <div class="mt-8 md:mt-0 md:ml-8">
                    <p class="text-sssm font-bold text-blackish p-ft uppercase pb-2">Government links</p>
