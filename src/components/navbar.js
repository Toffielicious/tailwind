    ...
    <div className="mx-auto px-4 sm:px-6 lg:px-8" style={{
        ...
        <div >
            <div className="flex flex-wrap items-center justify-between h-16">
                <div className="flex-shrink-0 flex flex-row pl-4 md:pl-20 gap-3 ">
                    ...
                    <div className="flex flex-col font-sanscinzel">
                        ...
                        <div className="flex flex-row space-x-2 sm:space-x-4 pt-2 ">
                            <a href="#" className="text-red font-bold hover:cursor-pointer">About PUP</a>
                            <a href="#" className="text-red font-bold px-2 md:px-7 hover:cursor-pointer">Academic</a>
                            <a href="#" className="text-red font-bold px-2 md:px-7 hover:cursor-pointer">Students</a>
                            <a href="#" className="text-red font-bold px-2 hover:cursor-pointer">Research</a>
                        </div>
                    </div>
                </div>
